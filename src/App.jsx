...
const genres=[
  ...
  return (
   ...
   {popup && (<div id="backdrop" onClick={()=>setPopup(false)} className="z-[50] fixed left-0 right-0 top-0 bottom-0 backdrop-brightness-50 max-md:backdrop-brightness-50 !h-full !w-full" />)}
    {popup && (<div className='!fixed -translate-x-2/4 -translate-y-2/4 z-[200] shadow-2xl left-2/4 top-1/2 !w-[75%] max-lg:!w-[85%] max-md:!w-[90%]'>  <div className='w-full bg-slate-100 rounded-md relative animate-[pop_0.4s_ease-out] scale-[.8]'>

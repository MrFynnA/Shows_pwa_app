...
import ScrollTopArrow from "../icons/icon";
...
const GotoTop = () => {
  ...
  return (
    <>
      <div
        className="group fixed cursor-pointer rounded-full border-2 border-neutral-500  overflow-hidden bg-[#ffffff9a] z-[999] w-10 text-center h-10 leading-10 md:right-[24px] right-[15px] bottom-[50px] max-md:bottom-[28px]"
        onClick={scrollTop}
        style={{
